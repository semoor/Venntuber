    ...
    public void createNotificationPlayer(String title, final int iconResourceResource) {
        ...
        ServiceConnection mConnection = new ServiceConnection() {
            public void onServiceConnected(ComponentName className,
                                           IBinder binder) {
                ((KilNotificationsService.KillBinder) binder).service.startService(new Intent(
                        context, KilNotificationsService.class));
        ...
        context.bindService(new Intent(context,
                        KilNotificationsService.class), mConnection,
